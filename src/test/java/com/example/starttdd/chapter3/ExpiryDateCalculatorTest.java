...
class ExpiryDateCalculatorTest {
    ...
    void 만원_납부하면_한달_뒤가_만료일이_됨() {
        ...
        assertExpiryDate(LocalDate.of(2019, 4, 1), 10_000, LocalDate.of(2019, 5, 1));
    }

    private void assertExpiryDate(LocalDate billingDate, int payment, LocalDate expectedExpiryDate) {
        ExpiryDateCalculator cal = new ExpiryDateCalculator();
        LocalDate expiryDate = cal.calculateExpiryDate(billingDate, payment);
